<?php
/**
 * Script WEB para adicionar usuário admin ao banco Aurora
 * Acesse via navegador: https://backend-socialmusic.onrender.com/database/create_admin_web.php
 */

require_once __DIR__ . '/../config/database.php';

echo "<h1>👤 CRIANDO USUÁRIO ADMIN</h1>";
echo "<pre>";
...
echo "</pre>";
echo "<p><a href='../database/reset_aurora_web.php'>⬅️ Resetar banco</a></p>";
